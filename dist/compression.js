 ...
 * @since 0.1.0
 */
import { gunzipSync, gzipSync, inflateSync, inflateRawSync, deflateSync, brotliCompressSync, brotliDecompressSync, } from "node:zlib";
 ...
 */
function decodeWith(fn, data, encoding) {
    try {
 ...
 * @since 0.1.0
 */
export class NodeZlibCompressionProvider {
